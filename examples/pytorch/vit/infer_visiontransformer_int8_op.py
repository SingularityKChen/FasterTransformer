...
import importlib  # Switch the version of the exported data

def load_module(module_name):
    module = importlib.import_module(module_name)
    return module.VisionTransformerINT8  
...
def validate(args, data_config, config, model):
    ...
    # add the name output
    for idx, (images, target, image_names) in enumerate(data_loader):
        ...
        op_tmp,_ = model.transformer(images_half, image_names)
